    ...
    return statValue > 0;
          ...
          .map((item) => (
            ...
            >
              ...
              <p className="text-[11px] font-bold text-yellow-500 text-center line-clamp-2 h-6 leading-tight">{item.name}</p>
              <p className="text-[15px] text-yellow-600 font-mono">{item.price} G</p>
            </button>
          ))}
      </div>
    </div>
